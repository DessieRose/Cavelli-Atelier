...
@section('title', '500 - Cavelli Atelier')
...
<main class="flex-1 bg-gray-50 flex items-center justify-center min-h-screen">
    <div class="text-center p-20 bg-gray-100 border border-gray-300 rounded-2xl shadow-sm max-w-md">
        <p class="text-6xl font-serif text-gray-300 mb-4">500</p>
        <h1 class="text-xl font-bold text-gray-800 mb-2">Server error</h1>
        <p class="text-gray-500 text-sm mb-8">Something went wrong on our end. Please try again later.</p>
        <a href="{{ route('login') }}"
