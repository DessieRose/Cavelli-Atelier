...
<aside class="fixed top-0 left-0 h-screen min-h-screen w-64 bg-sidebar p-5 lg:p-8 flex flex-col gap-6 lg:gap-10 overflow-y-auto z-10" aria-label="Main navigation">
