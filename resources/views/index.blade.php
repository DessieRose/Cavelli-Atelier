            ...
            <div class="bg-white rounded-lg shadow-md p-8">
                ...
                <form method="post" action="/login" class="space-y-4">
                    ...
                    <div>
                        ...
                        <input name="email" id="email" type="email" autocomplete="email" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" />
                    </div>
                    <div>
